...
from port.ProxyPool.proxypool.utils import parse_redis_connection_string
...
# 测试API
TEST_URL = env.str('TEST_URL', 'https://main.m.taobao.com/?ch=0&vt=2&_gp=0&dh_zy=&bookmark=&dh=&bookmark_pi=&mid=22l0pE')
